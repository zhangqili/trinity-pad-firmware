...
#define HID_INOUT_REPORT_DESC_SIZE 38
...
static const uint8_t hid_descriptor[] = {
    ...
    0x01,                        /* bNumDescriptors: Number of HID class descriptors to follow */
    0x22,                        /* bDescriptorType */
    HID_INOUT_REPORT_DESC_SIZE, /* wItemLength: Total length of Report descriptor */
    0x00,
...
static const uint8_t hid_inout_report_desc[HID_INOUT_REPORT_DESC_SIZE] = {
    /* USER CODE BEGIN 0 */
...
void hid_init(void)
{
    ...
    usbd_add_interface(usbd_hid_init_intf(&intf2, hid_inout_report_desc, HID_INOUT_REPORT_DESC_SIZE));
...
void hid_mouse_test(void)
{
    ...
    int ret = usbd_ep_start_write(HID_MOUSE_INT_EP, (uint8_t *)&mouse_cfg, 4);
    if (ret < 0) {
        return;
    }
    hid_state = HID_STATE_BUSY;
