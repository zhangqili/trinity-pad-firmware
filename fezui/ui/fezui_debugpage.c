...
static void debugpage_draw(void *page)
{
    ...
    //fezui_printf_right_aligned(&fezui,128,48,"%d",g_keyboard.advanced_keys[3].mode);
    //fezui_printf_right_aligned(&fezui,32,56,"%.3f",g_keyboard.advanced_keys[3].config.activation_value);
    //fezui_printf_right_aligned(&fezui,64,56,"%.3f",g_keyboard.advanced_keys[3].config.deactivation_value);
    //fezui_printf_right_aligned(&fezui,96,56,"%.3f",g_keyboard.advanced_keys[3].config.trigger_distance);
    //fezui_printf_right_aligned(&fezui,128,56,"%.3f",g_keyboard.advanced_keys[3].config.release_distance);

    //fezui_printf(&fezui,0,16,"%ld",g_keyboard.advanced_keys[0].value);
    //fezui_printf(&fezui,32,16,"%ld",g_keyboard.advanced_keys[1].value);
    //fezui_printf(&fezui,64,16,"%ld",g_keyboard.advanced_keys[2].value);
    //fezui_printf(&fezui,96,16,"%ld",g_keyboard.advanced_keys[3].value);
    //fezui_printf(&fezui,0,24,"%ld",g_keyboard.advanced_keys[0].raw);
    //fezui_printf(&fezui,32,24,"%ld",g_keyboard.advanced_keys[1].raw);
    //fezui_printf(&fezui,64,24,"%ld",g_keyboard.advanced_keys[2].raw);
    //fezui_printf(&fezui,96,24,"%ld",g_keyboard.advanced_keys[3].raw);
    //fezui_printf(&fezui,0,32,"%f", (g_keyboard.advanced_keys[0].config.upper_bound - g_keyboard.advanced_keys[0].raw) / (float)(g_keyboard.advanced_keys[0].config.upper_bound - g_keyboard.advanced_keys[0].config.lower_bound));
    //fezui_printf(&fezui,32,32,"%f",(g_keyboard.advanced_keys[1].config.upper_bound - g_keyboard.advanced_keys[1].raw) / (float)(g_keyboard.advanced_keys[1].config.upper_bound - g_keyboard.advanced_keys[1].config.lower_bound));
    //fezui_printf(&fezui,64,32,"%f",(g_keyboard.advanced_keys[2].config.upper_bound - g_keyboard.advanced_keys[2].raw) / (float)(g_keyboard.advanced_keys[2].config.upper_bound - g_keyboard.advanced_keys[2].config.lower_bound));
    //fezui_printf(&fezui,96,32,"%f",(g_keyboard.advanced_keys[3].config.upper_bound - g_keyboard.advanced_keys[3].raw) / (float)(g_keyboard.advanced_keys[3].config.upper_bound - g_keyboard.advanced_keys[3].config.lower_bound));
    //fezui_printf(&fezui,0,40,"%ld",g_keyboard.advanced_keys[0].config.trigger_distance);
    //fezui_printf(&fezui,32,40,"%ld",g_keyboard.advanced_keys[1].config.trigger_distance);
    //fezui_printf(&fezui,64,40,"%ld",g_keyboard.advanced_keys[2].config.trigger_distance);
    //fezui_printf(&fezui,96,40,"%ld",g_keyboard.advanced_keys[3].config.trigger_distance);
    //fezui_printf(&fezui,0,48,"%ld",g_keyboard.advanced_keys[0].config.release_distance);
    //fezui_printf(&fezui,32,48,"%ld",g_keyboard.advanced_keys[1].config.release_distance);
    //fezui_printf(&fezui,64,48,"%ld",g_keyboard.advanced_keys[2].config.release_distance);
    //fezui_printf(&fezui,96,48,"%ld",g_keyboard.advanced_keys[3].config.release_distance);
